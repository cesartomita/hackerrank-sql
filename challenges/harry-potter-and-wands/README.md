...
![1776718579674](image/README/1776718579674.png)

**Wands_Property**: The **code** is the code of the wand, **age** is the age of the wand, and **is_evil** denotes whether the wand is good for the dark arts. If the value of **is_evil** is `0`, it means that the wand is not evil. The mapping between **code** and **age** is one-one, meaning that if there are two pairs, `(code1, age1)` and `(code2, age2)`, then `code1 <> code2` and `age1 <> age2`.

![1776718594757](image/README/1776718594757.png)

## Sample Input

**Wands Table:**

![1776718799508](image/README/1776718799508.png)

**Wands_Property Table:**

![1776718817239](image/README/1776718817239.png)
...
![1776718837063](image/README/1776718837063.png)
...
![1776719300386](image/README/1776719300386.png)
...
![1776719321784](image/README/1776719321784.png)
...
![1776719332165](image/README/1776719332165.png)
